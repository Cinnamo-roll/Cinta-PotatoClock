...
@Tag(name = "Sessions", description = "Natural alias for focus session records")
@RestController
...
public class SessionAliasController {
    ...
    @GetMapping("/recent")
    public ApiResponse<List<PotatoSessionResponse>> recent(@RequestParam(defaultValue = "10") int limit) {
